...
```{=html}
<iframe src="authorship_diagram_ES.html" 
        width="100%" 
        height="1200px" 
...
\centering
\textbf{Recurso interactivo disponible en línea} \\[0.5em]
Ver recurso completo en: \cite{pantaleo2025} \\[0.3em]
